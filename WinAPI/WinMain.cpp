...
MainGame* _mg;
POINT	  _ptMouse;
HINSTANCE _hInstance; HWND _hWnd;

LRESULT CALLBACK WndProc(HWND, UINT, WPARAM, LPARAM);
void setWindowSize(int x, int y, int wideh, int height);

int APIENTRY WinMain ( HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR pszCmdParam, int nCmdShow )
{
	_mg = new MainGame();
	...
	_mg->release(); UnregisterClass(WINNAME, hInstance); return message.wParam;
}
